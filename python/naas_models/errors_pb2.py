...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_ERROR']._serialized_end=1078
  _globals['_ERRORRESPONSE']._serialized_start=67
  _globals['_ERRORRESPONSE']._serialized_end=193
