...
func file_workspace_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_workspace_proto_msgTypes[30].Exporter = func(v any, i int) any {
		...
		file_workspace_proto_msgTypes[31].Exporter = func(v any, i int) any {
		...
		file_workspace_proto_msgTypes[32].Exporter = func(v any, i int) any {
		...
		file_workspace_proto_msgTypes[33].Exporter = func(v any, i int) any {
		...
		file_workspace_proto_msgTypes[34].Exporter = func(v any, i int) any {
		...
		file_workspace_proto_msgTypes[35].Exporter = func(v any, i int) any {
