...
const file_workspace_proto_rawDesc = "" +
	...
	"\bfav_icon\x18\x03 \x01(\tH\x02R\afavIcon\x88\x01\x01\x12\"\n" +
	"\n" +
	"large_logo\x18\x04 \x01(\tH\x03R\tlargeLogo\x88\x01\x01\x12\"\n" +
	"\n" +
	"small_logo\x18\x05 \x01(\tH\x04R\tsmallLogo\x88\x01\x01\x12(\n" +
	"\rprimary_color\x18\x06 \x01(\tH\x05R\fprimaryColor\x88\x01\x01\x12,\n" +
	"\x0fsecondary_color\x18\a \x01(\tH\x06R\x0esecondaryColor\x88\x01\x01\x12*\n" +
	"\x0etertiary_color\x18\b \x01(\tH\aR\rtertiaryColor\x88\x01\x01\x121\n" +
	"\x12text_primary_color\x18\t \x01(\tH\bR\x10textPrimaryColor\x88\x01\x01\x125\n" +
	"\x14text_secondary_color\x18\n" +
	" \x01(\tH\tR\x12textSecondaryColor\x88\x01\x01\x12$\n" +
	"\vis_personal\x18\v \x01(\bH\n" +
	"R\n" +
	...
	"\n" +
	"large_logo\x18\x03 \x01(\tH\x02R\tlargeLogo\x88\x01\x01\x12\"\n" +
	"\n" +
	"small_logo\x18\x04 \x01(\tH\x03R\tsmallLogo\x88\x01\x01\x12(\n" +
	"\rprimary_color\x18\x05 \x01(\tH\x04R\fprimaryColor\x88\x01\x01\x12,\n" +
	"\x0fsecondary_color\x18\x06 \x01(\tH\x05R\x0esecondaryColor\x88\x01\x01\x12*\n" +
	"\x0etertiary_color\x18\a \x01(\tH\x06R\rtertiaryColor\x88\x01\x01\x121\n" +
	"\x12text_primary_color\x18\b \x01(\tH\aR\x10textPrimaryColor\x88\x01\x01\x125\n" +
	"\x14text_secondary_color\x18\t \x01(\tH\bR\x12textSecondaryColor\x88\x01\x01\x12$\n" +
	"\vis_personal\x18\n" +
	" \x01(\bH\tR\n" +
	"isPersonal\x88\x01\x01B\a\n" +
	"\x05_nameB\v\n" +
	"\t_fav_iconB\r\n" +
	"\v_large_logoB\r\n" +
	"\v_small_logoB\x10\n" +
	...
	"\n" +
	"large_logo\x18\x04 \x01(\tH\x02R\tlargeLogo\x88\x01\x01\x12\"\n" +
	"\n" +
	"small_logo\x18\x05 \x01(\tH\x03R\tsmallLogo\x88\x01\x01\x12(\n" +
	...
	"\x04role\x18\x03 \x01(\tB\x1b\xfaB\x18r\x16R\x05ownerR\x05adminR\x06memberH\x02R\x04role\x88\x01\x01\x12=\n" +
	"\x06status\x18\x04 \x01(\tB \xfaB\x1dr\x1bR\x06activeR\ainvitedR\bdeclinedH\x03R\x06status\x88\x01\x01\x12 \n" +
	"\tcreate_at\x18\x05 \x01(\tH\x04R\bcreateAt\x88\x01\x01\x12 \n" +
	"\tupdate_at\x18\x06 \x01(\tH\x05R\bupdateAt\x88\x01\x01\x12\"\n" +
	"\n" +
	"first_name\x18\a \x01(\tH\x06R\tfirstName\x88\x01\x01\x12 \n" +
	"\tlast_name\x18\b \x01(\tH\aR\blastName\x88\x01\x01\x12\x19\n" +
	"\x05email\x18\t \x01(\tH\bR\x05email\x88\x01\x01\x123\n" +
	"\x13profile_picture_url\x18\n" +
	" \x01(\tH\tR\x11profilePictureUrl\x88\x01\x01B\n" +
	"\n" +
	"\b_user_idB\x0f\n" +
	"\r_workspace_idB\a\n" +
	"\x05_roleB\t\n" +
	...
	"_last_nameB\b\n" +
	"\x06_emailB\x16\n" +
	"\x14_profile_picture_url\"\x9e\x01\n" +
	"\x13WorkspaceUserUpdate\x124\n" +
	"\x04role\x18\x01 \x01(\tB\x1b\xfaB\x18r\x16R\x05ownerR\x05adminR\x06memberH\x00R\x04role\x88\x01\x01\x12=\n" +
	"\x06status\x18\x02 \x01(\tB \xfaB\x1dr\x1bR\x06activeR\ainvitedR\bdeclinedH\x01R\x06status\x88\x01\x01B\a\n" +
	"\x05_roleB\t\n" +
	"\a_status\"\x88\x02\n" +
	"\x0fWorkspacePlugin\x12\x1d\n" +
	"\x02id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\x02id\x88\x01\x01\x120\n" +
	"\fworkspace_id\x18\x02 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x01R\vworkspaceId\x88\x01\x01\x12\x1d\n" +
	"\apayload\x18\x03 \x01(\tH\x02R\apayload\x88\x01\x01\x12\"\n" +
	"\n" +
	"created_at\x18\x04 \x01(\tH\x03R\tcreatedAt\x88\x01\x01\x12 \n" +
	"\tis_public\x18\x05 \x01(\bH\x04R\bisPublic\x88\x01\x01B\x05\n" +
	"\x03_idB\x0f\n" +
	"\r_workspace_idB\n" +
	"\n" +
	"\b_payloadB\r\n" +
	...
	"\n" +
	"_is_public\"r\n" +
	"\x15WorkspacePluginUpdate\x12\x1d\n" +
	"\apayload\x18\x01 \x01(\tH\x00R\apayload\x88\x01\x01\x12 \n" +
	"\tis_public\x18\x02 \x01(\bH\x01R\bisPublic\x88\x01\x01B\n" +
	"\n" +
	"\b_payloadB\f\n" +
	"\n" +
	"_is_public\"J\n" +
	"\x14WorkspaceListRequest\x12&\n" +
	"\auser_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\x06userId\x88\x01\x01B\n" +
	"\n" +
	"\b_user_id\"\x89\x01\n" +
	...
	"\x06_error\"Q\n" +
	"\x1bInvitedWorkspaceListRequest\x12&\n" +
	"\auser_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\x06userId\x88\x01\x01B\n" +
	"\n" +
	"\b_user_id\"\x90\x01\n" +
	"\x1cInvitedWorkspaceListResponse\x124\n" +
	"\n" +
	"workspaces\x18\x01 \x03(\v2\x14.workspace.WorkspaceR\n" +
	"workspaces\x120\n" +
	"\x05error\x18\x02 \x01(\v2\x15.errors.ErrorResponseH\x00R\x05error\x88\x01\x01B\b\n" +
	...
	"\auser_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\x06userId\x88\x01\x01\x12?\n" +
	"\tworkspace\x18\x02 \x01(\v2\x1c.workspace.WorkspaceCreationH\x01R\tworkspace\x88\x01\x01B\n" +
	"\n" +
	"\b_user_idB\f\n" +
	"\n" +
	"_workspace\"\x9c\x01\n" +
	"\x17WorkspaceCreateResponse\x127\n" +
	"\tworkspace\x18\x01 \x01(\v2\x14.workspace.WorkspaceH\x00R\tworkspace\x88\x01\x01\x120\n" +
	"\x05error\x18\x02 \x01(\v2\x15.errors.ErrorResponseH\x01R\x05error\x88\x01\x01B\f\n" +
	"\n" +
	"_workspaceB\b\n" +
	"\x06_error\"\x8c\x01\n" +
	"\x13WorkspaceGetRequest\x12&\n" +
	"\auser_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\x06userId\x88\x01\x01\x120\n" +
	"\fworkspace_id\x18\x02 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x01R\vworkspaceId\x88\x01\x01B\n" +
	"\n" +
	"\b_user_idB\x0f\n" +
	"\r_workspace_id\"\x99\x01\n" +
	"\x14WorkspaceGetResponse\x127\n" +
	"\tworkspace\x18\x01 \x01(\v2\x14.workspace.WorkspaceH\x00R\tworkspace\x88\x01\x01\x120\n" +
	"\x05error\x18\x02 \x01(\v2\x15.errors.ErrorResponseH\x01R\x05error\x88\x01\x01B\f\n" +
	"\n" +
	"_workspaceB\b\n" +
	"\x06_error\"\xa8\x01\n" +
	"\x16WorkspaceUpdateRequest\x120\n" +
	"\fworkspace_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\vworkspaceId\x88\x01\x01\x12=\n" +
	"\tworkspace\x18\x02 \x01(\v2\x1a.workspace.WorkspaceUpdateH\x01R\tworkspace\x88\x01\x01B\x0f\n" +
	"\r_workspace_idB\f\n" +
	"\n" +
	"_workspace\"\x9c\x01\n" +
	"\x17WorkspaceUpdateResponse\x127\n" +
	"\tworkspace\x18\x01 \x01(\v2\x14.workspace.WorkspaceH\x00R\tworkspace\x88\x01\x01\x120\n" +
	"\x05error\x18\x02 \x01(\v2\x15.errors.ErrorResponseH\x01R\x05error\x88\x01\x01B\f\n" +
	"\n" +
	"_workspaceB\b\n" +
	"\x06_error\"\x8f\x01\n" +
	"\x16WorkspaceDeleteRequest\x12&\n" +
	"\auser_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\x06userId\x88\x01\x01\x120\n" +
	"\fworkspace_id\x18\x02 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x01R\vworkspaceId\x88\x01\x01B\n" +
	"\n" +
	"\b_user_idB\x0f\n" +
	"\r_workspace_id\"U\n" +
	"\x17WorkspaceDeleteResponse\x120\n" +
	"\x05error\x18\x01 \x01(\v2\x15.errors.ErrorResponseH\x00R\x05error\x88\x01\x01B\b\n" +
	"\x06_error\"\xec\x01\n" +
	"\x1aWorkspaceInviteUserRequest\x120\n" +
	"\fworkspace_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x01R\vworkspaceId\x88\x01\x01\x12#\n" +
	"\auser_id\x18\x02 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\x06userId\x12\x1f\n" +
	"\x05email\x18\x03 \x01(\tB\a\xfaB\x04r\x02`\x01H\x00R\x05email\x124\n" +
	"\x04role\x18\x04 \x01(\tB\x1b\xfaB\x18r\x16R\x05ownerR\x05adminR\x06memberH\x02R\x04role\x88\x01\x01B\x06\n" +
	"\x04userB\x0f\n" +
	"\r_workspace_idB\a\n" +
	"\x05_role\"\xb2\x01\n" +
	"\x1bWorkspaceInviteUserResponse\x12D\n" +
	"\x0eworkspace_user\x18\x01 \x01(\v2\x18.workspace.WorkspaceUserH\x00R\rworkspaceUser\x88\x01\x01\x120\n" +
	"\x05error\x18\x02 \x01(\v2\x15.errors.ErrorResponseH\x01R\x05error\x88\x01\x01B\x11\n" +
	"\x0f_workspace_userB\b\n" +
	"\x06_error\"]\n" +
	"\x18WorkspaceUserListRequest\x120\n" +
	"\fworkspace_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\vworkspaceId\x88\x01\x01B\x0f\n" +
	"\r_workspace_id\"\x9a\x01\n" +
	"\x19WorkspaceUserListResponse\x12A\n" +
	"\x0fworkspace_users\x18\x01 \x03(\v2\x18.workspace.WorkspaceUserR\x0eworkspaceUsers\x120\n" +
	"\x05error\x18\x02 \x01(\v2\x15.errors.ErrorResponseH\x00R\x05error\x88\x01\x01B\b\n" +
	"\x06_error\"\x90\x01\n" +
	"\x17WorkspaceUserGetRequest\x12&\n" +
	"\auser_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\x06userId\x88\x01\x01\x120\n" +
	"\fworkspace_id\x18\x02 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x01R\vworkspaceId\x88\x01\x01B\n" +
	"\n" +
	"\b_user_idB\x0f\n" +
	"\r_workspace_id\"\xaf\x01\n" +
	"\x18WorkspaceUserGetResponse\x12D\n" +
	"\x0eworkspace_user\x18\x01 \x01(\v2\x18.workspace.WorkspaceUserH\x00R\rworkspaceUser\x88\x01\x01\x120\n" +
	"\x05error\x18\x02 \x01(\v2\x15.errors.ErrorResponseH\x01R\x05error\x88\x01\x01B\x11\n" +
	"\x0f_workspace_userB\b\n" +
	"\x06_error\"\xf2\x01\n" +
	"\x1aWorkspaceUserUpdateRequest\x12&\n" +
	"\auser_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\x06userId\x88\x01\x01\x120\n" +
	"\fworkspace_id\x18\x02 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x01R\vworkspaceId\x88\x01\x01\x12J\n" +
	"\x0eworkspace_user\x18\x03 \x01(\v2\x1e.workspace.WorkspaceUserUpdateH\x02R\rworkspaceUser\x88\x01\x01B\n" +
	"\n" +
	"\b_user_idB\x0f\n" +
	"\r_workspace_idB\x11\n" +
	"\x0f_workspace_user\"\xb2\x01\n" +
	"\x1bWorkspaceUserUpdateResponse\x12D\n" +
	"\x0eworkspace_user\x18\x01 \x01(\v2\x18.workspace.WorkspaceUserH\x00R\rworkspaceUser\x88\x01\x01\x120\n" +
	"\x05error\x18\x02 \x01(\v2\x15.errors.ErrorResponseH\x01R\x05error\x88\x01\x01B\x11\n" +
	"\x0f_workspace_userB\b\n" +
	"\x06_error\"\x93\x01\n" +
	"\x1aWorkspaceUserDeleteRequest\x12&\n" +
	"\auser_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\x06userId\x88\x01\x01\x120\n" +
	"\fworkspace_id\x18\x02 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x01R\vworkspaceId\x88\x01\x01B\n" +
	"\n" +
	"\b_user_idB\x0f\n" +
	"\r_workspace_id\"Y\n" +
	"\x1bWorkspaceUserDeleteResponse\x120\n" +
	"\x05error\x18\x01 \x01(\v2\x15.errors.ErrorResponseH\x00R\x05error\x88\x01\x01B\b\n" +
	"\x06_error\"\xbc\x01\n" +
	"\x1cWorkspacePluginCreateRequest\x120\n" +
	"\fworkspace_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\vworkspaceId\x88\x01\x01\x12\x1d\n" +
	"\apayload\x18\x02 \x01(\tH\x01R\apayload\x88\x01\x01\x12 \n" +
	"\tis_public\x18\x03 \x01(\bH\x02R\bisPublic\x88\x01\x01B\x0f\n" +
	"\r_workspace_idB\n" +
	"\n" +
	"\b_payloadB\f\n" +
	"\n" +
	"_is_public\"\xbc\x01\n" +
	"\x1dWorkspacePluginCreateResponse\x12J\n" +
	"\x10workspace_plugin\x18\x01 \x01(\v2\x1a.workspace.WorkspacePluginH\x00R\x0fworkspacePlugin\x88\x01\x01\x120\n" +
	"\x05error\x18\x02 \x01(\v2\x15.errors.ErrorResponseH\x01R\x05error\x88\x01\x01B\x13\n" +
	"\x11_workspace_pluginB\b\n" +
	"\x06_error\"\x98\x01\n" +
	"\x19WorkspacePluginGetRequest\x120\n" +
	"\fworkspace_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\vworkspaceId\x88\x01\x01\x12*\n" +
	"\tplugin_id\x18\x02 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x01R\bpluginId\x88\x01\x01B\x0f\n" +
	"\r_workspace_idB\f\n" +
	"\n" +
	"_plugin_id\"\xb9\x01\n" +
	"\x1aWorkspacePluginGetResponse\x12J\n" +
	"\x10workspace_plugin\x18\x01 \x01(\v2\x1a.workspace.WorkspacePluginH\x00R\x0fworkspacePlugin\x88\x01\x01\x120\n" +
	"\x05error\x18\x02 \x01(\v2\x15.errors.ErrorResponseH\x01R\x05error\x88\x01\x01B\x13\n" +
	"\x11_workspace_pluginB\b\n" +
	"\x06_error\"_\n" +
	"\x1aWorkspacePluginListRequest\x120\n" +
	"\fworkspace_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\vworkspaceId\x88\x01\x01B\x0f\n" +
	"\r_workspace_id\"\xa2\x01\n" +
	"\x1bWorkspacePluginListResponse\x12G\n" +
	"\x11workspace_plugins\x18\x01 \x03(\v2\x1a.workspace.WorkspacePluginR\x10workspacePlugins\x120\n" +
	"\x05error\x18\x02 \x01(\v2\x15.errors.ErrorResponseH\x00R\x05error\x88\x01\x01B\b\n" +
	"\x06_error\"\x82\x02\n" +
	"\x1cWorkspacePluginUpdateRequest\x120\n" +
	"\fworkspace_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\vworkspaceId\x88\x01\x01\x12*\n" +
	"\tplugin_id\x18\x02 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x01R\bpluginId\x88\x01\x01\x12P\n" +
	"\x10workspace_plugin\x18\x03 \x01(\v2 .workspace.WorkspacePluginUpdateH\x02R\x0fworkspacePlugin\x88\x01\x01B\x0f\n" +
	"\r_workspace_idB\f\n" +
	"\n" +
	"_plugin_idB\x13\n" +
	"\x11_workspace_plugin\"\xbc\x01\n" +
	"\x1dWorkspacePluginUpdateResponse\x12J\n" +
	"\x10workspace_plugin\x18\x01 \x01(\v2\x1a.workspace.WorkspacePluginH\x00R\x0fworkspacePlugin\x88\x01\x01\x120\n" +
	"\x05error\x18\x02 \x01(\v2\x15.errors.ErrorResponseH\x01R\x05error\x88\x01\x01B\x13\n" +
	"\x11_workspace_pluginB\b\n" +
	"\x06_error\"\x9b\x01\n" +
	"\x1cWorkspacePluginDeleteRequest\x120\n" +
	"\fworkspace_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\vworkspaceId\x88\x01\x01\x12*\n" +
	"\tplugin_id\x18\x02 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x01R\bpluginId\x88\x01\x01B\x0f\n" +
	"\r_workspace_idB\f\n" +
	"\n" +
	"_plugin_id\"[\n" +
	"\x1dWorkspacePluginDeleteResponse\x120\n" +
	"\x05error\x18\x01 \x01(\v2\x15.errors.ErrorResponseH\x00R\x05error\x88\x01\x01B\b\n" +
	"\x06_error\"Y\n" +
	"\x14WorkspaceWipeRequest\x120\n" +
	"\fworkspace_id\x18\x01 \x01(\tB\b\xfaB\x05r\x03\xb0\x01\x01H\x00R\vworkspaceId\x88\x01\x01B\x0f\n" +
	"\r_workspace_id\"S\n" +
