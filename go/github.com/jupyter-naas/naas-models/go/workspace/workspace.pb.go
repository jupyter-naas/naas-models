...
func file_workspace_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_workspace_proto_msgTypes[36].Exporter = func(v any, i int) any {
		...
		file_workspace_proto_msgTypes[37].Exporter = func(v any, i int) any {
		...
		file_workspace_proto_msgTypes[38].Exporter = func(v any, i int) any {
		...
		file_workspace_proto_msgTypes[39].Exporter = func(v any, i int) any {
