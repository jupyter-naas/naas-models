...
const file_p2p_validate_proto_rawDesc = "" +
	"\n" +
	"\x12p2p_validate.proto\x12\fp2p_validate\x1a google/protobuf/descriptor.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"(\n" +
	"\n" +
	"OneofRules\x12\x1a\n" +
	"\boptional\x18\x01 \x03(\tR\boptional\"\xb1\t\n" +
	"\n" +
	"FieldRules\x129\n" +
	"\amessage\x18\x11 \x01(\v2\x1a.p2p_validate.MessageRulesH\x01R\amessage\x88\x01\x01\x120\n" +
	"\x05float\x18\x01 \x01(\v2\x18.p2p_validate.FloatRulesH\x00R\x05float\x123\n" +
	"\x06double\x18\x02 \x01(\v2\x19.p2p_validate.DoubleRulesH\x00R\x06double\x120\n" +
	"\x05int32\x18\x03 \x01(\v2\x18.p2p_validate.Int32RulesH\x00R\x05int32\x120\n" +
	"\x05int64\x18\x04 \x01(\v2\x18.p2p_validate.Int64RulesH\x00R\x05int64\x123\n" +
	"\x06uint32\x18\x05 \x01(\v2\x19.p2p_validate.UInt32RulesH\x00R\x06uint32\x123\n" +
	"\x06uint64\x18\x06 \x01(\v2\x19.p2p_validate.UInt64RulesH\x00R\x06uint64\x123\n" +
	"\x06sint32\x18\a \x01(\v2\x19.p2p_validate.SInt32RulesH\x00R\x06sint32\x123\n" +
	"\x06sint64\x18\b \x01(\v2\x19.p2p_validate.SInt64RulesH\x00R\x06sint64\x126\n" +
	"\afixed32\x18\t \x01(\v2\x1a.p2p_validate.Fixed32RulesH\x00R\afixed32\x126\n" +
	"\afixed64\x18\n" +
	" \x01(\v2\x1a.p2p_validate.Fixed64RulesH\x00R\afixed64\x129\n" +
	"\bsfixed32\x18\v \x01(\v2\x1b.p2p_validate.SFixed32RulesH\x00R\bsfixed32\x129\n" +
	"\bsfixed64\x18\f \x01(\v2\x1b.p2p_validate.SFixed64RulesH\x00R\bsfixed64\x12-\n" +
	"\x04bool\x18\r \x01(\v2\x17.p2p_validate.BoolRulesH\x00R\x04bool\x123\n" +
	"\x06string\x18\x0e \x01(\v2\x19.p2p_validate.StringRulesH\x00R\x06string\x120\n" +
	"\x05bytes\x18\x0f \x01(\v2\x18.p2p_validate.BytesRulesH\x00R\x05bytes\x12-\n" +
	"\x04enum\x18\x10 \x01(\v2\x17.p2p_validate.EnumRulesH\x00R\x04enum\x129\n" +
	"\brepeated\x18\x12 \x01(\v2\x1b.p2p_validate.RepeatedRulesH\x00R\brepeated\x12*\n" +
	"\x03map\x18\x13 \x01(\v2\x16.p2p_validate.MapRulesH\x00R\x03map\x12*\n" +
	"\x03any\x18\x14 \x01(\v2\x16.p2p_validate.AnyRulesH\x00R\x03any\x129\n" +
	"\bduration\x18\x15 \x01(\v2\x1b.p2p_validate.DurationRulesH\x00R\bduration\x12<\n" +
	"\ttimestamp\x18\x16 \x01(\v2\x1c.p2p_validate.TimestampRulesH\x00R\ttimestampB\x06\n" +
	"\x04typeB\n" +
	"\n" +
	"\b_message\"\xb5\x06\n" +
	"\n" +
	"FloatRules\x12\x19\n" +
	"\x05const\x18\x01 \x01(\x02H\x02R\x05const\x88\x01\x01\x12\x13\n" +
	"\x02lt\x18\x02 \x01(\x02H\x03R\x02lt\x88\x01\x01\x12\x13\n" +
	"\x02le\x18\x03 \x01(\x02H\x04R\x02le\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x04 \x01(\x02H\x05R\x02gt\x88\x01\x01\x12\x13\n" +
	"\x02ge\x18\x05 \x01(\x02H\x06R\x02ge\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\x06 \x03(\x02R\x02in\x12\x15\n" +
	"\x06not_in\x18\a \x03(\x02R\x05notIn\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\aR\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\x02H\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	"\fmiss_default\x18\v \x01(\bH\x00R\vmissDefault\x12\x1c\n" +
	"\brequired\x18\x15 \x01(\bH\x00R\brequired\x12+\n" +
	"\x10default_template\x18\x16 \x01(\tH\x00R\x0fdefaultTemplate\x12\x19\n" +
	"\x05alias\x18\f \x01(\tH\bR\x05alias\x88\x01\x01\x12%\n" +
	"\vdescription\x18\r \x01(\tH\tR\vdescription\x88\x01\x01\x12$\n" +
	"\vmultiple_of\x18\x0e \x01(\x02H\n" +
	"R\n" +
	"multipleOf\x88\x01\x01\x12\x1a\n" +
	"\aexample\x18\x0f \x01(\x02H\x01R\aexample\x12)\n" +
	"\x0fexample_factory\x18\x10 \x01(\tH\x01R\x0eexampleFactory\x12\x19\n" +
	"\x05field\x18\x11 \x01(\tH\vR\x05field\x88\x01\x01\x12\x17\n" +
	"\x04type\x18\x12 \x01(\tH\fR\x04type\x88\x01\x01\x12\x19\n" +
	"\x05title\x18\x13 \x01(\tH\rR\x05title\x88\x01\x01\x12\x19\n" +
	"\x05extra\x18\x14 \x01(\tH\x0eR\x05extra\x88\x01\x01B\x10\n" +
	"\x0edefault_configB\x10\n" +
	"\x0eexample_configB\b\n" +
	"\x06_constB\x05\n" +
	"\x03_ltB\x05\n" +
	"\x03_leB\x05\n" +
	"\x03_gtB\x05\n" +
	...
	"\x05const\x18\x01 \x01(\x01H\x02R\x05const\x88\x01\x01\x12\x13\n" +
	"\x02lt\x18\x02 \x01(\x01H\x03R\x02lt\x88\x01\x01\x12\x13\n" +
	"\x02le\x18\x03 \x01(\x01H\x04R\x02le\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x04 \x01(\x01H\x05R\x02gt\x88\x01\x01\x12\x13\n" +
	"\x02ge\x18\x05 \x01(\x01H\x06R\x02ge\x88\x01\x01\x12\x0e\n" +
	...
	"\n" +
	"Int32Rules\x12\x19\n" +
	"\x05const\x18\x01 \x01(\x05H\x02R\x05const\x88\x01\x01\x12\x13\n" +
	"\x02lt\x18\x02 \x01(\x05H\x03R\x02lt\x88\x01\x01\x12\x13\n" +
	"\x02le\x18\x03 \x01(\x05H\x04R\x02le\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x04 \x01(\x05H\x05R\x02gt\x88\x01\x01\x12\x13\n" +
	"\x02ge\x18\x05 \x01(\x05H\x06R\x02ge\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\x06 \x03(\x05R\x02in\x12\x15\n" +
	"\x06not_in\x18\a \x03(\x05R\x05notIn\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\aR\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\x02H\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	...
	"\n" +
	"Int64Rules\x12\x19\n" +
	"\x05const\x18\x01 \x01(\x03H\x02R\x05const\x88\x01\x01\x12\x13\n" +
	"\x02lt\x18\x02 \x01(\x03H\x03R\x02lt\x88\x01\x01\x12\x13\n" +
	"\x02le\x18\x03 \x01(\x03H\x04R\x02le\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x04 \x01(\x03H\x05R\x02gt\x88\x01\x01\x12\x13\n" +
	"\x02ge\x18\x05 \x01(\x03H\x06R\x02ge\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\x06 \x03(\x03R\x02in\x12\x15\n" +
	"\x06not_in\x18\a \x03(\x03R\x05notIn\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\aR\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\x02H\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	...
	"\x05const\x18\x01 \x01(\rH\x02R\x05const\x88\x01\x01\x12\x13\n" +
	"\x02lt\x18\x02 \x01(\rH\x03R\x02lt\x88\x01\x01\x12\x13\n" +
	"\x02le\x18\x03 \x01(\rH\x04R\x02le\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x04 \x01(\rH\x05R\x02gt\x88\x01\x01\x12\x13\n" +
	"\x02ge\x18\x05 \x01(\rH\x06R\x02ge\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\x06 \x03(\rR\x02in\x12\x15\n" +
	"\x06not_in\x18\a \x03(\rR\x05notIn\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\aR\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\x02H\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	...
	"\x05const\x18\x01 \x01(\x04H\x02R\x05const\x88\x01\x01\x12\x13\n" +
	"\x02lt\x18\x02 \x01(\x04H\x03R\x02lt\x88\x01\x01\x12\x13\n" +
	"\x02le\x18\x03 \x01(\x04H\x04R\x02le\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x04 \x01(\x04H\x05R\x02gt\x88\x01\x01\x12\x13\n" +
	"\x02ge\x18\x05 \x01(\x04H\x06R\x02ge\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\x06 \x03(\x04R\x02in\x12\x15\n" +
	"\x06not_in\x18\a \x03(\x04R\x05notIn\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\aR\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\x02H\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	...
	"\x05const\x18\x01 \x01(\x11H\x02R\x05const\x88\x01\x01\x12\x13\n" +
	"\x02lt\x18\x02 \x01(\x11H\x03R\x02lt\x88\x01\x01\x12\x13\n" +
	"\x02le\x18\x03 \x01(\x11H\x04R\x02le\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x04 \x01(\x11H\x05R\x02gt\x88\x01\x01\x12\x13\n" +
	"\x02ge\x18\x05 \x01(\x11H\x06R\x02ge\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\x06 \x03(\x11R\x02in\x12\x15\n" +
	"\x06not_in\x18\a \x03(\x11R\x05notIn\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\aR\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\x02H\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	...
	"\x05const\x18\x01 \x01(\x12H\x02R\x05const\x88\x01\x01\x12\x13\n" +
	"\x02lt\x18\x02 \x01(\x12H\x03R\x02lt\x88\x01\x01\x12\x13\n" +
	"\x02le\x18\x03 \x01(\x12H\x04R\x02le\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x04 \x01(\x12H\x05R\x02gt\x88\x01\x01\x12\x13\n" +
	"\x02ge\x18\x05 \x01(\x12H\x06R\x02ge\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\x06 \x03(\x12R\x02in\x12\x15\n" +
	"\x06not_in\x18\a \x03(\x12R\x05notIn\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\aR\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\x02H\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	...
	"\x05const\x18\x01 \x01(\aH\x02R\x05const\x88\x01\x01\x12\x13\n" +
	"\x02lt\x18\x02 \x01(\aH\x03R\x02lt\x88\x01\x01\x12\x13\n" +
	"\x02le\x18\x03 \x01(\aH\x04R\x02le\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x04 \x01(\aH\x05R\x02gt\x88\x01\x01\x12\x13\n" +
	"\x02ge\x18\x05 \x01(\aH\x06R\x02ge\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\x06 \x03(\aR\x02in\x12\x15\n" +
	"\x06not_in\x18\a \x03(\aR\x05notIn\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\aR\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\x02H\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	...
	"\x05const\x18\x01 \x01(\x06H\x02R\x05const\x88\x01\x01\x12\x13\n" +
	"\x02lt\x18\x02 \x01(\x06H\x03R\x02lt\x88\x01\x01\x12\x13\n" +
	"\x02le\x18\x03 \x01(\x06H\x04R\x02le\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x04 \x01(\x06H\x05R\x02gt\x88\x01\x01\x12\x13\n" +
	"\x02ge\x18\x05 \x01(\x06H\x06R\x02ge\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\x06 \x03(\x06R\x02in\x12\x15\n" +
	"\x06not_in\x18\a \x03(\x06R\x05notIn\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\aR\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\x02H\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	...
	"\x05const\x18\x01 \x01(\x0fH\x02R\x05const\x88\x01\x01\x12\x13\n" +
	"\x02lt\x18\x02 \x01(\x0fH\x03R\x02lt\x88\x01\x01\x12\x13\n" +
	"\x02le\x18\x03 \x01(\x0fH\x04R\x02le\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x04 \x01(\x0fH\x05R\x02gt\x88\x01\x01\x12\x13\n" +
	"\x02ge\x18\x05 \x01(\x0fH\x06R\x02ge\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\x06 \x03(\x0fR\x02in\x12\x15\n" +
	"\x06not_in\x18\a \x03(\x0fR\x05notIn\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\aR\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\x02H\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	...
	"\x05const\x18\x01 \x01(\x10H\x02R\x05const\x88\x01\x01\x12\x13\n" +
	"\x02lt\x18\x02 \x01(\x10H\x03R\x02lt\x88\x01\x01\x12\x13\n" +
	"\x02le\x18\x03 \x01(\x10H\x04R\x02le\x88\x01\x01\x12\x13\n" +
	"\x02gt\x18\x04 \x01(\x10H\x05R\x02gt\x88\x01\x01\x12\x13\n" +
	"\x02ge\x18\x05 \x01(\x10H\x06R\x02ge\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\x06 \x03(\x10R\x02in\x12\x15\n" +
	"\x06not_in\x18\a \x03(\x10R\x05notIn\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\aR\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\x02H\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	...
	"\x06_extra\"\x8e\x04\n" +
	"\tBoolRules\x12\x19\n" +
	"\x05const\x18\x01 \x01(\bH\x01R\x05const\x88\x01\x01\x12\x1b\n" +
	"\x06enable\x18\x02 \x01(\bH\x02R\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\x03 \x01(\bH\x00R\adefault\x12#\n" +
	"\fmiss_default\x18\v \x01(\bH\x00R\vmissDefault\x12\x1c\n" +
	"\brequired\x18\x15 \x01(\bH\x00R\brequired\x12+\n" +
	"\x10default_template\x18\x16 \x01(\tH\x00R\x0fdefaultTemplate\x12\x19\n" +
	"\x05alias\x18\x05 \x01(\tH\x03R\x05alias\x88\x01\x01\x12%\n" +
	"\vdescription\x18\x06 \x01(\tH\x04R\vdescription\x88\x01\x01\x12\x1d\n" +
	"\aexample\x18\a \x01(\bH\x05R\aexample\x88\x01\x01\x12\x19\n" +
	"\x05field\x18\b \x01(\tH\x06R\x05field\x88\x01\x01\x12\x17\n" +
	"\x04type\x18\t \x01(\tH\aR\x04type\x88\x01\x01\x12\x19\n" +
	"\x05title\x18\x13 \x01(\tH\bR\x05title\x88\x01\x01\x12\x19\n" +
	"\x05extra\x18\x14 \x01(\tH\tR\x05extra\x88\x01\x01B\x10\n" +
	"\x0edefault_configB\b\n" +
	"\x06_constB\t\n" +
	"\a_enableB\b\n" +
	"\x06_aliasB\x0e\n" +
	"\f_descriptionB\n" +
	...
	"\x05const\x18\x01 \x01(\tH\x03R\x05const\x88\x01\x01\x12\x15\n" +
	"\x03len\x18\x02 \x01(\x04H\x04R\x03len\x88\x01\x01\x12\"\n" +
	"\n" +
	"min_length\x18\x03 \x01(\x04H\x05R\tminLength\x88\x01\x01\x12\"\n" +
	"\n" +
	"max_length\x18\x04 \x01(\x04H\x06R\tmaxLength\x88\x01\x01\x12\x1d\n" +
	"\apattern\x18\x05 \x01(\tH\aR\apattern\x88\x01\x01\x12\x1b\n" +
	"\x06prefix\x18\x06 \x01(\tH\bR\x06prefix\x88\x01\x01\x12\x1b\n" +
	"\x06suffix\x18\a \x01(\tH\tR\x06suffix\x88\x01\x01\x12\x1f\n" +
	"\bcontains\x18\b \x01(\tH\n" +
	"R\bcontains\x88\x01\x01\x12&\n" +
	"\fnot_contains\x18\t \x01(\tH\vR\vnotContains\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\n" +
	" \x03(\tR\x02in\x12\x15\n" +
	...
	"\x04uuid\x18\x16 \x01(\bH\x00R\x04uuid\x12%\n" +
	"\rpydantic_type\x18c \x01(\tH\x00R\fpydanticType\x12\x1b\n" +
	"\x06enable\x18\x17 \x01(\bH\fR\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\x18 \x01(\tH\x01R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\x19 \x01(\tH\x01R\x0edefaultFactory\x12#\n" +
	"\fmiss_default\x18\x1a \x01(\bH\x01R\vmissDefault\x12\x1c\n" +
	"\brequired\x18# \x01(\bH\x01R\brequired\x12+\n" +
	"\x10default_template\x18$ \x01(\tH\x01R\x0fdefaultTemplate\x12\x19\n" +
	"\x05alias\x18\x1b \x01(\tH\rR\x05alias\x88\x01\x01\x12%\n" +
	"\vdescription\x18\x1c \x01(\tH\x0eR\vdescription\x88\x01\x01\x12\x1a\n" +
	"\aexample\x18\x1e \x01(\tH\x02R\aexample\x12)\n" +
	"\x0fexample_factory\x18\x1f \x01(\tH\x02R\x0eexampleFactory\x12\x19\n" +
	"\x05field\x18  \x01(\tH\x0fR\x05field\x88\x01\x01\x12\x17\n" +
	"\x04type\x18! \x01(\tH\x10R\x04type\x88\x01\x01\x12\x19\n" +
	"\x05title\x18\" \x01(\tH\x11R\x05title\x88\x01\x01\x12\x19\n" +
	"\x05extra\x18\x14 \x01(\tH\x12R\x05extra\x88\x01\x01B\f\n" +
	"\n" +
	"well_knownB\x10\n" +
	"\x0edefault_configB\x10\n" +
	"\x0eexample_configB\b\n" +
	...
	"\n" +
	"BytesRules\x12\x19\n" +
	"\x05const\x18\x01 \x01(\fH\x03R\x05const\x88\x01\x01\x12\"\n" +
	"\n" +
	"min_length\x18\x02 \x01(\x04H\x04R\tminLength\x88\x01\x01\x12\"\n" +
	"\n" +
	"max_length\x18\x03 \x01(\x04H\x05R\tmaxLength\x88\x01\x01\x12\x1b\n" +
	"\x06prefix\x18\x05 \x01(\fH\x06R\x06prefix\x88\x01\x01\x12\x1b\n" +
	"\x06suffix\x18\x06 \x01(\fH\aR\x06suffix\x88\x01\x01\x12\x1f\n" +
	"\bcontains\x18\a \x01(\fH\bR\bcontains\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\b \x03(\fR\x02in\x12\x15\n" +
	"\x06not_in\x18\t \x03(\fR\x05notIn\x12\x1b\n" +
	"\x06enable\x18\n" +
	" \x01(\bH\tR\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\v \x01(\fH\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\f \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	"\fmiss_default\x18\r \x01(\bH\x00R\vmissDefault\x12\x1c\n" +
	"\brequired\x18\x1a \x01(\bH\x00R\brequired\x12+\n" +
	"\x10default_template\x18$ \x01(\tH\x00R\x0fdefaultTemplate\x12\x19\n" +
	"\x05alias\x18\x0e \x01(\tH\n" +
	"R\x05alias\x88\x01\x01\x12%\n" +
	"\vdescription\x18\x0f \x01(\tH\vR\vdescription\x88\x01\x01\x12$\n" +
	"\vmultiple_of\x18\x10 \x01(\x02H\fR\n" +
	"multipleOf\x88\x01\x01\x12\x1a\n" +
	"\aexample\x18\x11 \x01(\fH\x01R\aexample\x12)\n" +
	"\x0fexample_factory\x18\x12 \x01(\tH\x01R\x0eexampleFactory\x12\x19\n" +
	"\x05field\x18\x13 \x01(\tH\rR\x05field\x88\x01\x01\x12\x17\n" +
	"\x04type\x18\x14 \x01(\tH\x0eR\x04type\x88\x01\x01\x12\x10\n" +
	"\x02ip\x18\x15 \x01(\bH\x02R\x02ip\x12\x14\n" +
	"\x04ipv4\x18\x16 \x01(\bH\x02R\x04ipv4\x12\x14\n" +
	"\x04ipv6\x18\x17 \x01(\bH\x02R\x04ipv6\x12\x19\n" +
	"\x05title\x18\x18 \x01(\tH\x0fR\x05title\x88\x01\x01\x12\x19\n" +
	"\x05extra\x18\x19 \x01(\tH\x10R\x05extra\x88\x01\x01B\x10\n" +
	"\x0edefault_configB\x10\n" +
	"\x0eexample_configB\f\n" +
	"\n" +
	"well_knownB\b\n" +
	"\x06_constB\r\n" +
	"\v_min_lengthB\r\n" +
	...
	"\x06_extra\"\xec\x04\n" +
	"\tEnumRules\x12\x19\n" +
	"\x05const\x18\x01 \x01(\x05H\x02R\x05const\x88\x01\x01\x12\x0e\n" +
	"\x02in\x18\x03 \x03(\x05R\x02in\x12\x15\n" +
	"\x06not_in\x18\x04 \x03(\x05R\x05notIn\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\x03R\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\x05H\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	"\fmiss_default\x18\v \x01(\bH\x00R\vmissDefault\x12\x1c\n" +
	"\brequired\x18\x15 \x01(\bH\x00R\brequired\x12+\n" +
	"\x10default_template\x18\x16 \x01(\tH\x00R\x0fdefaultTemplate\x12\x19\n" +
	"\x05alias\x18\f \x01(\tH\x04R\x05alias\x88\x01\x01\x12%\n" +
	"\vdescription\x18\r \x01(\tH\x05R\vdescription\x88\x01\x01\x12\x1a\n" +
	"\aexample\x18\x0f \x01(\x05H\x01R\aexample\x12)\n" +
	"\x0fexample_factory\x18\x10 \x01(\tH\x01R\x0eexampleFactory\x12\x19\n" +
	"\x05field\x18\x11 \x01(\tH\x06R\x05field\x88\x01\x01\x12\x19\n" +
	"\x05title\x18\x12 \x01(\tH\aR\x05title\x88\x01\x01\x12\x19\n" +
	"\x05extra\x18\x14 \x01(\tH\bR\x05extra\x88\x01\x01B\x10\n" +
	"\x0edefault_configB\x10\n" +
	"\x0eexample_configB\b\n" +
	"\x06_constB\t\n" +
	"\a_enableB\b\n" +
	...
	"\x06_titleB\b\n" +
	"\x06_extra\"\xe7\x04\n" +
	"\fMessageRules\x12\x17\n" +
	"\x04skip\x18\x01 \x01(\bH\x02R\x04skip\x88\x01\x01\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\x03R\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\x02H\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	"\fmiss_default\x18\v \x01(\bH\x00R\vmissDefault\x12\x1c\n" +
	"\brequired\x18\x02 \x01(\bH\x00R\brequired\x12+\n" +
	"\x10default_template\x18\x16 \x01(\tH\x00R\x0fdefaultTemplate\x12\x19\n" +
	"\x05alias\x18\f \x01(\tH\x04R\x05alias\x88\x01\x01\x12%\n" +
	"\vdescription\x18\r \x01(\tH\x05R\vdescription\x88\x01\x01\x12\x1a\n" +
	"\aexample\x18\x0f \x01(\x02H\x01R\aexample\x12)\n" +
	"\x0fexample_factory\x18\x10 \x01(\tH\x01R\x0eexampleFactory\x12\x19\n" +
	"\x05field\x18\x11 \x01(\tH\x06R\x05field\x88\x01\x01\x12\x17\n" +
	"\x04type\x18\x12 \x01(\tH\aR\x04type\x88\x01\x01\x12\x19\n" +
	"\x05title\x18\x13 \x01(\tH\bR\x05title\x88\x01\x01\x12\x19\n" +
	"\x05extra\x18\x14 \x01(\tH\tR\x05extra\x88\x01\x01B\x10\n" +
	"\x0edefault_configB\x10\n" +
	"\x0eexample_configB\a\n" +
	"\x05_skipB\t\n" +
	"\a_enableB\b\n" +
	"\x06_aliasB\x0e\n" +
	"\f_descriptionB\b\n" +
	...
	"\x06_extra\"\xd5\x05\n" +
	"\rRepeatedRules\x12 \n" +
	"\tmin_items\x18\x01 \x01(\x04H\x02R\bminItems\x88\x01\x01\x12 \n" +
	"\tmax_items\x18\x02 \x01(\x04H\x03R\bmaxItems\x88\x01\x01\x12\x1b\n" +
	"\x06unique\x18\x03 \x01(\bH\x04R\x06unique\x88\x01\x01\x123\n" +
	"\x05items\x18\x04 \x01(\v2\x18.p2p_validate.FieldRulesH\x05R\x05items\x88\x01\x01\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\x06R\x06enable\x88\x01\x01\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	"\fmiss_default\x18\v \x01(\bH\x00R\vmissDefault\x12\x1c\n" +
	"\brequired\x18\x15 \x01(\bH\x00R\brequired\x12+\n" +
	"\x10default_template\x18\x16 \x01(\tH\x00R\x0fdefaultTemplate\x12\x19\n" +
	"\x05alias\x18\f \x01(\tH\aR\x05alias\x88\x01\x01\x12%\n" +
	"\vdescription\x18\r \x01(\tH\bR\vdescription\x88\x01\x01\x12)\n" +
	"\x0fexample_factory\x18\x10 \x01(\tH\x01R\x0eexampleFactory\x12\x19\n" +
	"\x05field\x18\x11 \x01(\tH\tR\x05field\x88\x01\x01\x12\x17\n" +
	"\x04type\x18\x12 \x01(\tH\n" +
	"R\x04type\x88\x01\x01\x12\x19\n" +
	"\x05title\x18\x13 \x01(\tH\vR\x05title\x88\x01\x01\x12\x19\n" +
	"\x05extra\x18\x14 \x01(\tH\fR\x05extra\x88\x01\x01B\x10\n" +
	"\x0edefault_configB\x10\n" +
	"\x0eexample_configB\f\n" +
	"\n" +
	"_min_itemsB\f\n" +
	...
	"\x06_extra\"\xe7\x05\n" +
	"\bMapRules\x12 \n" +
	"\tmin_pairs\x18\x01 \x01(\x04H\x02R\bminPairs\x88\x01\x01\x12 \n" +
	"\tmax_pairs\x18\x02 \x01(\x04H\x03R\bmaxPairs\x88\x01\x01\x121\n" +
	"\x04keys\x18\x04 \x01(\v2\x18.p2p_validate.FieldRulesH\x04R\x04keys\x88\x01\x01\x125\n" +
	"\x06values\x18\x05 \x01(\v2\x18.p2p_validate.FieldRulesH\x05R\x06values\x88\x01\x01\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\x06R\x06enable\x88\x01\x01\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	"\fmiss_default\x18\v \x01(\bH\x00R\vmissDefault\x12\x1c\n" +
	...
	"\x06not_in\x18\x03 \x03(\tR\x05notIn\x12\x1b\n" +
	"\x06enable\x18\b \x01(\bH\x02R\x06enable\x88\x01\x01\x12\x1a\n" +
	"\adefault\x18\t \x01(\tH\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	"\fmiss_default\x18\v \x01(\bH\x00R\vmissDefault\x12\x1c\n" +
	"\brequired\x18\x01 \x01(\bH\x00R\brequired\x12+\n" +
	"\x10default_template\x18\x16 \x01(\tH\x00R\x0fdefaultTemplate\x12\x19\n" +
	"\x05alias\x18\f \x01(\tH\x03R\x05alias\x88\x01\x01\x12%\n" +
	"\vdescription\x18\r \x01(\tH\x04R\vdescription\x88\x01\x01\x12\x1a\n" +
	"\aexample\x18\x0e \x01(\tH\x01R\aexample\x12)\n" +
	"\x0fexample_factory\x18\x0f \x01(\tH\x01R\x0eexampleFactory\x12\x19\n" +
	"\x05field\x18\x10 \x01(\tH\x05R\x05field\x88\x01\x01\x12\x19\n" +
	"\x05title\x18\x11 \x01(\tH\x06R\x05title\x88\x01\x01\x12\x19\n" +
	"\x05extra\x18\x14 \x01(\tH\aR\x05extra\x88\x01\x01B\x10\n" +
	"\x0edefault_configB\x10\n" +
	"\x0eexample_configB\t\n" +
	"\a_enableB\b\n" +
	"\x06_aliasB\x0e\n" +
	...
	"\x06_extra\"\xf5\a\n" +
	"\rDurationRules\x124\n" +
	"\x05const\x18\x02 \x01(\v2\x19.google.protobuf.DurationH\x02R\x05const\x88\x01\x01\x12.\n" +
	"\x02lt\x18\x03 \x01(\v2\x19.google.protobuf.DurationH\x03R\x02lt\x88\x01\x01\x12.\n" +
	"\x02le\x18\x04 \x01(\v2\x19.google.protobuf.DurationH\x04R\x02le\x88\x01\x01\x12.\n" +
	"\x02gt\x18\x05 \x01(\v2\x19.google.protobuf.DurationH\x05R\x02gt\x88\x01\x01\x12.\n" +
	"\x02ge\x18\x06 \x01(\v2\x19.google.protobuf.DurationH\x06R\x02ge\x88\x01\x01\x12)\n" +
	"\x02in\x18\a \x03(\v2\x19.google.protobuf.DurationR\x02in\x120\n" +
	"\x06not_in\x18\b \x03(\v2\x19.google.protobuf.DurationR\x05notIn\x12\x1b\n" +
	"\x06enable\x18\x0e \x01(\bH\aR\x06enable\x88\x01\x01\x125\n" +
	"\adefault\x18\t \x01(\v2\x19.google.protobuf.DurationH\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\n" +
	" \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	"\fmiss_default\x18\v \x01(\bH\x00R\vmissDefault\x12\x1c\n" +
	"\brequired\x18\x01 \x01(\bH\x00R\brequired\x12+\n" +
	"\x10default_template\x18\x16 \x01(\tH\x00R\x0fdefaultTemplate\x12\x19\n" +
	"\x05alias\x18\f \x01(\tH\bR\x05alias\x88\x01\x01\x12%\n" +
	"\vdescription\x18\r \x01(\tH\tR\vdescription\x88\x01\x01\x125\n" +
	"\aexample\x18\x0f \x01(\v2\x19.google.protobuf.DurationH\x01R\aexample\x12)\n" +
	"\x0fexample_factory\x18\x10 \x01(\tH\x01R\x0eexampleFactory\x12\x19\n" +
	"\x05field\x18\x11 \x01(\tH\n" +
	"R\x05field\x88\x01\x01\x12\x17\n" +
	"\x04type\x18\x12 \x01(\tH\vR\x04type\x88\x01\x01\x12\x19\n" +
	"\x05title\x18\x13 \x01(\tH\fR\x05title\x88\x01\x01\x12\x19\n" +
	"\x05extra\x18\x14 \x01(\tH\rR\x05extra\x88\x01\x01B\x10\n" +
	"\x0edefault_configB\x10\n" +
	"\x0eexample_configB\b\n" +
	"\x06_constB\x05\n" +
	"\x03_ltB\x05\n" +
	...
	"\x06_titleB\b\n" +
	"\x06_extra\"\xb1\b\n" +
	"\x0eTimestampRules\x125\n" +
	"\x05const\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampH\x02R\x05const\x88\x01\x01\x12/\n" +
	"\x02lt\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampH\x03R\x02lt\x88\x01\x01\x12/\n" +
	"\x02le\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampH\x04R\x02le\x88\x01\x01\x12/\n" +
	"\x02gt\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampH\x05R\x02gt\x88\x01\x01\x12/\n" +
	"\x02ge\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampH\x06R\x02ge\x88\x01\x01\x12\x1a\n" +
	"\x06lt_now\x18\a \x01(\bH\aR\x05ltNow\x88\x01\x01\x12\x1a\n" +
	"\x06gt_now\x18\b \x01(\bH\bR\x05gtNow\x88\x01\x01\x126\n" +
	"\x06within\x18\t \x01(\v2\x19.google.protobuf.DurationH\tR\x06within\x88\x01\x01\x12\x1b\n" +
	"\x06enable\x18\n" +
	" \x01(\bH\n" +
	"R\x06enable\x88\x01\x01\x126\n" +
	"\adefault\x18\v \x01(\v2\x1a.google.protobuf.TimestampH\x00R\adefault\x12)\n" +
	"\x0fdefault_factory\x18\f \x01(\tH\x00R\x0edefaultFactory\x12#\n" +
	"\fmiss_default\x18\r \x01(\bH\x00R\vmissDefault\x12\x1c\n" +
	"\brequired\x18\x01 \x01(\bH\x00R\brequired\x12+\n" +
	"\x10default_template\x18\x16 \x01(\tH\x00R\x0fdefaultTemplate\x12\x19\n" +
	"\x05alias\x18\x0e \x01(\tH\vR\x05alias\x88\x01\x01\x12%\n" +
	"\vdescription\x18\x0f \x01(\tH\fR\vdescription\x88\x01\x01\x126\n" +
	"\aexample\x18\x10 \x01(\v2\x1a.google.protobuf.TimestampH\x01R\aexample\x12)\n" +
	"\x0fexample_factory\x18\x11 \x01(\tH\x01R\x0eexampleFactory\x12\x19\n" +
	"\x05field\x18\x12 \x01(\tH\rR\x05field\x88\x01\x01\x12\x17\n" +
	"\x04type\x18\x13 \x01(\tH\x0eR\x04type\x88\x01\x01\x12\x19\n" +
	"\x05title\x18\x14 \x01(\tH\x0fR\x05title\x88\x01\x01\x12\x19\n" +
	"\x05extra\x18\x15 \x01(\tH\x10R\x05extra\x88\x01\x01B\x10\n" +
	"\x0edefault_configB\x10\n" +
	"\x0eexample_configB\b\n" +
	"\x06_constB\x05\n" +
	"\x03_ltB\x05\n" +
	...
	"\x06_titleB\b\n" +
	"\x06_extra:=\n" +
	"\aignored\x12\x1f.google.protobuf.MessageOptions\x18\xb1\b \x01(\bR\aignored\x88\x01\x01:=\n" +
	"\brequired\x12\x1d.google.protobuf.OneofOptions\x18\xb1\b \x01(\bR\brequired\x88\x01\x01:^\n" +
	"\foneof_extend\x12\x1d.google.protobuf.OneofOptions\x18\xb2\b \x01(\v2\x18.p2p_validate.OneofRulesR\voneofExtend\x88\x01\x01:Q\n" +
	"\x05rules\x12\x1d.google.protobuf.FieldOptions\x18\xb1\b \x01(\v2\x18.p2p_validate.FieldRulesR\x05rules\x88\x01\x01B5Z3github.com/jupyter-naas/naas-models/go/p2p_validateb\x06proto3"
